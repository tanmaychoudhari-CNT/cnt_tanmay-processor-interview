      ...
      >
        ...
        <div className="hidden md:flex flex-1 bg-blue-600 relative overflow-hidden p-16 flex-col items-center justify-center">
          ...
          <img
            src={logoUrl}
            alt="Signapay"
            className="absolute top-8 left-8 h-7 w-auto select-none brightness-0 invert opacity-90 z-10"
            draggable={false}
          />

          <div className="relative z-10 text-center text-white mb-16">
            <h3 className="text-3xl font-semibold mb-4 leading-tight tracking-tight">
              Effortlessly manage your team and operations.
            </h3>
            <p className="text-blue-50 opacity-90 font-normal">
